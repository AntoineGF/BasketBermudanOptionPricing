function S = CorrelatedBrownian(S0,r,y,sigma,corr_matrix,T,steps,nsims)
% rng default
...
%
% Output: S            = a 3 dimensional matrix of size steps X nsims X n_assets
%
% Note: The original code was taken from 'Goddard Consulting' and was
% subsequently modified to fit the task. Source: 
